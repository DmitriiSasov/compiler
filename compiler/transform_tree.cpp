...
//Ќаходит модификаторы ближайшего родительского метода с идентичной сигнатурой или метода указанного класса
...
bool checkMethods(classS* clas, programS* program)
{
	...
	for (auto cbe = clas->body->first; cbe != 0; cbe = cbe->next)
	{
		if (cbe->method != 0)
		{
			...
			//«амен€ем им€ на им€ стандартной функции моей библиотеки
